...
import AndroidStore from '../../assets/shop/googleplay.png';
import IOSStore from '../../assets/shop/appstore.png';
import DownloadApp from '../../assets/shop/e-shop.png';
                ...
                <Container>
                    <Row className='align-items-center'>
                        <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
                            ...
                            <h2>save up to 20%</h2>
                            <p>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus illum officiis ipsum. Rem earum harum dolores.
                            </p>
                            <Link to='/'>
                                <img src={AndroidStore} alt="IOS" className='img-fluid me-3 store' />
                            </Link>
                            <Link to='/'>
                                <img src={IOSStore} alt="Android" className='img-fluid me-3 store' />
                            </Link>
                        </Col>
                        <Col lg={6}>
