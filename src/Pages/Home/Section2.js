                ...
                <Container>
                    <Row>
                        <Col lg={{ span: 8, offset: 2 }} className='text-center'>
                            ...
                            <p>
                                "Serving sizzling burgers, your ultimate destination for mouthwatering flavors and irresistible burger cravings satisfaction!"
                            </p>
                        ...
                        <Col md={6} lg={4} className='mb-4 mb-md-0'>
                            <div className="about_box text-center">
                                <div className="about_icon">
                                    <img src={cardData.image}  className='img-fluid' alt="icon" key={index}/>
                                </div>
